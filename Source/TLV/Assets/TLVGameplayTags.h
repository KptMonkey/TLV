...
namespace TLVGameplayTags
{
	...
	TLV_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_Look)
	...
	TLV_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_Dodge)
	...
	TLV_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Ability_Attack_Melee_Heavy_Axe)
	TLV_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Ability_Attack_Melee_Light_Stick)
	TLV_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Ability_Attack_Melee_Heavy_Stick)
	TLV_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Ability_Attack_Melee_Light_Saw)
	TLV_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Ability_Attack_Melee_Heavy_Saw)
	TLV_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Ability_Attack_Melee_Light_Sword)
	TLV_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Ability_Attack_Melee_Heavy_Sword)
	...
	TLV_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Event_SwitchTarget_Right)
	TLV_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Event_SwitchTarget_Left)

	TLV_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Weapon_Stick)
	TLV_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Weapon_Saw)
	TLV_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Weapon_Axe)
	TLV_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Weapon_Sword)
	...
	TLV_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameData_Level_1);
	TLV_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameData_Level_2);
	TLV_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameData_Level_3);
